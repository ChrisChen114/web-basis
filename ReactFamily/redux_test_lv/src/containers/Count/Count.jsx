...
class Count extends Component {
	...
	render() {
		return (
			<div>
                <h2>我是Count组件,当前Person组件总人数人{this.props.personCount}</h2>
...
// 使用connect(mapStateToProps,mapDispatchToProps)(UI组件),创建并暴露一个Count的容器组件
...
export default connect(
    ...
    {
		// 触发对象简写形式
        increment,// 程序员只准备到action，然后react-redux会自动dispatch
        decrement,
        incrementAsync
    }
