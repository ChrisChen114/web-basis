...
import { increment,decrement,incrementByAmount } from '../../redux/count_reducer.js'
...
const Count = ()=> {
    ...
    //     console.log('value-',this.selectNumber.value)
    //     // const value = 1;
    //     // // 
    //     store.dispatch({type:'increment',data:1});//value*1
    // }
    ...
    return (
        <div>
            <div>
                ...
                {/* aria-label="Increment value"  */}
                <button aria-label="Decrement value" onClick={() => dispatch(increment())}>Increment</button>&nbsp;
                <button aria-label="Decrement value" onClick={() => dispatch(decrement())}>Decrement</button>&nbsp;
                {/* <button aria-label="IncrementByAmount value" onClick={() => dispatch(incrementByAmount() )}
                >IncrementByAmount</button> */}
                {/* <button onClick={incrementByAmount()}>当前求和为奇数再加</button>&nbsp;
