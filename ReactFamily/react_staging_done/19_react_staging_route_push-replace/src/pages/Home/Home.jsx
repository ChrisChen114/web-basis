        ...
        <div>
          <ul className="nav nav-tabs">
            <li>
              ...
              <NavLink replace className={({ isActive }) => "list-group-item" + (isActive ? " atguigu" : "")} to="/home/news">News</NavLink>
            </li>
            <li>
              <MyNavLink replace className={({ isActive }) => "list-group-item" + (isActive ? " atguigu" : "")} to="/home/message">Message</MyNavLink>
            </li>
          </ul>
          {/* 注册路由 */}
          <Routes>
