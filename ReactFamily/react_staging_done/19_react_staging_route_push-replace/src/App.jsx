        ...
        <div className="row">
          <div className="col-xs-2 col-xs-offset-2">
            <div className="list-group">
              ...
              {/* 实现了高亮 */}
              <NavLink replace className={({ isActive }) => "list-group-item" + (isActive ? " atguigu" : "")} to="/about">About</NavLink>
              <NavLink replace className={({ isActive }) => "list-group-item" + (isActive ? " atguigu" : "")} to="/home">Home</NavLink>
            </div>
          </div>
